...
Pod::Spec.new do |s|
  s.name             = 'HSRange'
  s.version          = '0.1.0'
  s.summary          = 'A short description of HSRange.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Hitendra Solanki/HSRange'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Hitendra Solanki' => 'hitendra.developer@gmail.com' }
  s.source           = { :git => 'https://github.com/Hitendra Solanki/HSRange.git', :tag => s.version.to_s }
